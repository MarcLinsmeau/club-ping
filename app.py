...
try:
    ...
    # --- LOGIQUE DE CONTRÔLE ET REQUÊTE ---
    st.markdown("---")
    if not st.session_state.annee_choisie:
        ...
        if df_res.empty:
            ...
            tcd_base = df_res.pivot_table(
                ...
                aggfunc={"MatchNonFF": "size", "Match": "size", "VictoireJ1": "sum", "PointsJ1": "sum"}, fill_value=0
