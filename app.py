...
try:
    ...
    # Initialisation des clés de session requises pour les contrôles tactiles
    ...
    # Étape 2 : Choix des clubs (dépend de l'année)
    ...
    # Étape 3 : Choix des joueurs (dépend de l'année et du club)
    ...
    if not st.session_state.annee_choisie:
        ...
        # Construction de la requête sur la table principale
        ...
        if df_res.empty:
            ...
            if tcd_base.empty:
                ...
                # Forçage du format String sur le niveau de l'index 'Semaine'
                ...
                if len(st.session_state.joueurs_choisis) == 1:
                    ...
                    # Graphe 1 : Histogramme Hebdomadaire (Gestion de dy stricte)
                ...
                # Fusion finale et tri chronologique
                ...
                # Règle de style CSS dynamique pour cibler les lignes de totaux
                ...
                # Génération de la table HTML stylisée
                html_table = (
